    ...
    <Layout>
      <div className="pt-16 pb-12 md:pt-20">
        <div className="container mx-auto px-4 py-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-serif text-center mb-8 text-cafe-dark-brown relative after:content-[''] after:block after:w-24 after:h-1 after:bg-cafe-light-brown after:mx-auto after:mt-4">
              Nuestra Historia
            </h1>
            ...
            <div className="bg-white shadow-sm rounded-lg p-8 mb-12">
              ...
              >
                ...
                <h2 className="text-2xl font-serif mt-10 mb-4 text-cafe-dark-brown border-b border-cafe-beige pb-2">Nuestra Filosofía</h2>
                <p className="mb-6">
                ...
                <div className="bg-cafe-beige bg-opacity-20 p-6 rounded-lg mb-10 border-l-4 border-cafe-light-brown">
                  <h3 className="text-xl font-serif mb-3 text-cafe-dark-brown">Compromiso con la Sostenibilidad</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="text-cafe-light-brown mt-1 font-bold">✓</span>
                ...
                <h2 className="text-2xl font-serif mt-10 mb-4 text-cafe-dark-brown border-b border-cafe-beige pb-2">Nuestro Equipo</h2>
                <p className="mb-6">
            ...
            >
              <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-cafe-light-brown">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-cafe-dark-brown">
